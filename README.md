...
# 🔄 Qwarisma AnalytiX Serialization Library

[![C++20](https://img.shields.io/badge/C%2B%2B-20-blue.svg?style=flat&logo=c%2B%2B)](https://isocpp.org/)
[![CMake](https://img.shields.io/badge/CMake-3.15%2B-blue.svg?style=flat&logo=cmake)](https://cmake.org/)
[![License](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)
[![Build Status](https://img.shields.io/badge/Build-Passing-brightgreen.svg)]()
[![Platform](https://img.shields.io/badge/Platform-Windows%20%7C%20Linux%20%7C%20macOS-lightgrey.svg)]()
[![PRs Welcome](https://img.shields.io/badge/PRs-Welcome-brightgreen.svg)](CONTRIBUTING.md)

**A high-performance, type-safe serialization library for modern C++ featuring compile-time reflection, concepts-based type constraints, and support for both JSON and binary formats.**

[Features](#features) • [Installation](#installation) • [Quick Start](#quick-start) • [Documentation](#api-reference) • [Contributing](CONTRIBUTING.md)
...
- **nlohmann/json** - Included in `ThirdParty/` (no separate installation needed)
- Standard library with C++20 support (concepts, std::format, std::source_location)
...
git clone https://github.com/QwarismaAnalytiX/Serialization.git
cd Serialization
...
### Option 2: Add as CMake Subdirectory

Add this repository as a subdirectory in your project:
...
```cpp
#include "serialization_impl.h"  // Main header
#include "common/serialization_macros.h"  // For reflection macros
#include "util/multi_process_stream.h"  // For binary serialization
```
...
- **C++20 Standard** - Concepts, std::format, std::source_location
- Inspired by [Boost.Serialization](https://www.boost.org/doc/libs/release/libs/serialization/) and [Cereal](https://uscilab.github.io/cereal/)

---

## About Qwarisma AnalytiX

Qwarisma AnalytiX develops high-performance software solutions for data processing, analytics, and enterprise applications. Our tools are designed with modern C++ best practices, emphasizing type safety, performance, and developer experience.

📧 **Email**: [qwarismaanalytix@hotmail.com](mailto:qwarismaanalytix@hotmail.com)
🔗 **GitHub**: [github.com/QwarismaAnalytiX](https://github.com/QwarismaAnalytiX)
🔒 **Security**: Report vulnerabilities to [qwarismaanalytix@hotmail.com](mailto:qwarismaanalytix@hotmail.com) - See [SECURITY.md](SECURITY.md)

---

<div align="center">

**Made with ❤️ by [Qwarisma AnalytiX](https://github.com/QwarismaAnalytiX)**
